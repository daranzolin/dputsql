CREATE TABLE IF NOT EXISTS mtcars2 (
	id integer PRIMARY KEY,
	mpg numeric NOT NULL UNIQUE CHECK(mpg > 0),
	cyl numeric NOT NULL UNIQUE,
	disp numeric,
	...
	vs numeric,
	am numeric,
	gear numeric   DEFAULT 0,
	carb numeric
);

INSERT INTO mtcars2 (`id`, `mpg`, `cyl`, `disp`, `hp`, `drat`, `wt`, `qsec`, `vs`, `am`, `gear`, `carb`) VALUES
